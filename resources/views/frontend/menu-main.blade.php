<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl text-blue-700  whitespace-nowrap dark:text-white">Empresa SAC</span>
        </a>
        <!-- end logo -->
        ...
        <div class=" md:order-2 flex ">
            ...
            <div class="flex items-center ml-4">
                ...
                <div class="flex items-center  space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                        ...
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            ...
                            <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Notificaciones</a>
                            </li>
                            <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Publicar</a>
                            </li>
                            <li>
                ...
                @else
                    <div class="flex ">
                        <a href="{{ route('login') }}" class="text-sm text-blue-700 dark:text-white hover:text-gray-900 hover:outline hover:outline-offset-4 hover:rounded-sm hover:outline-blue-500">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-blue-700 dark:text-white hover:text-gray-900 hover:outline hover:outline-offset-4 hover:rounded-sm hover:outline-blue-500">Register</a>
                        @endif
                    </div>
                @endauth

                 <!-- btn responsive menu site-->
                <button data-collapse-toggle="navbar-user" type="button" class="ml-5 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
                <span class="sr-only">Open main menu</span>
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15"/>
                </svg>
                </button>
                <!-- End btn responsive menu -->
            </div>
        </div>
        <!-- end btn -->
        ...
        <!-- menu center -->
        <div class="items-center justify-between hidden w-full md:flex md:order-1 md:w-auto" id="navbar-user">
